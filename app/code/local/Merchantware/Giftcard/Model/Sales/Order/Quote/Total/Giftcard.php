...
class Merchantware_Giftcard_Model_Sales_Order_Quote_Total_Giftcard extends Mage_Sales_Model_Quote_Address_Total_Abstract
{
	...
	protected function _aggregateItemDiscount($amount){
		...
		/*
			Subtract the giftcard discount from the quote.
			*/
